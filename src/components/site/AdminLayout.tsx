  ...
  return (
    <div className="grid min-h-screen grid-cols-1 bg-muted/30 lg:grid-cols-[260px_1fr]">
      ...
      <div className="flex flex-col">
        <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-border/60 bg-background/85 px-4 py-3.5 backdrop-blur sm:px-6">
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            <SheetTrigger asChild>
              <button className="grid h-9 w-9 place-items-center rounded-full border border-border bg-card hover:bg-muted lg:hidden">
